...
- `rift-duel-prompt.md`: mockups de una serie 1v1 al mejor de 3 entre amigos (ejemplo: Quex vs Mingo). Usa el design system Rift Duel: Pattern Library v2 más colores por lado (`blue-side`, `red-side`). Sus archivos y una galería local para verlo están en `rift-duel/`.
