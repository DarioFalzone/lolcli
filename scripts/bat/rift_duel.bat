...
REM Regenera fixture.html desde fixture.json y lo sirve en localhost.
...
set RIFT_URL=http://localhost:%RIFT_PORT%/fixture.html
...
"%PY%" -m http.server %RIFT_PORT% --bind 127.0.0.1 --directory "%RIFT_DIR%"
