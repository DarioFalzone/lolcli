...
def download_all_splash_arts(image_delay=0.2, champion_delay=0.4, max_retries=5):
    ...
    for idx, (_champion_key, champion_data) in enumerate(champions.items(), 1):
...
def download_single_champion(champion_name, image_delay=0.2, max_retries=5):
    ...
    for _key, data in champions.items():
...
if __name__ == "__main__":
    ...
    if args.champion:
        ...
        download_all_splash_arts(
            image_delay=args.image_delay, champion_delay=args.champion_delay, max_retries=args.max_retries
        )
